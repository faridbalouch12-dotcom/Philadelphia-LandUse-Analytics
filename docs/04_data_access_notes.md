...
| **Update cadence** | New 5-year estimates released annually, but valid comparisons require non-overlapping windows. **MVP windows: 2016–2020 and 2019–2023** (two API calls per window). TIGER/Line tract boundaries fetched once. |
