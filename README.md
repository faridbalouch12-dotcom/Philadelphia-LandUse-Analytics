...
- **Write access by layer policy:** [`docs/policies/write_access_by_layer.md`](./docs/policies/write_access_by_layer.md)
...
- **Local reset runbook:** [`docs/runbooks/local_reset.md`](./docs/runbooks/local_reset.md)
- **DB bootstrap verification:** [`docs/runbooks/db_bootstrap_verification.md`](./docs/runbooks/db_bootstrap_verification.md)
