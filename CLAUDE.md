...
**Action:** Run the `/grade` skill with the task ID or file path. The skill handles the full workflow: loading the rubric, running Pass/Fail gates, scoring all 5 criteria, delivering feedback, asking the meta-learning question, and updating `.claude/progress.md` and `docs/README.md` links on PASS.
