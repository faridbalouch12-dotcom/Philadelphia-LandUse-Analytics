...
1. **Geometry validity** — Farid's first instinct: make sure the district polygons themselves don't overlap or leave gaps. Right answer.
...
**Farid's answer:** "this task connects to earlier work we've done as we discussed calculating land areas, mapping smaller things like polygons from the zoning dataset to the planning district"
